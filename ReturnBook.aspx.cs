...
public partial class ReturnBook : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con1.Open();
        SqlCommand cmd = new SqlCommand("insert into [Return](Regno,Date_of_return,Date_of_issue,Name,Course,Author,Edition) values('"+ DropDownList2.Text +"','" + TextBox6.Text + "','" + TextBox5.Text + "','" + DropDownList1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "')", con1);
        cmd.ExecuteNonQuery();
    ...
    {
        SqlConnection con2 = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\Db.mdf;Integrated Security=True");
        con2.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Return]", con2);
        cmd.ExecuteNonQuery();
